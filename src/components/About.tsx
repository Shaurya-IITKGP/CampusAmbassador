  ...
  return (
    <div className='grid justify-center '>
     ...
     <div className=' text-5xl font-extrabold flex justify-center font-sans  bg-gradient-to-r from-lightOrange via-orange-400 to-darkOrange bg-clip-text text-transparent bg'>
        <span className='  w-full text-center underline text-lightOrange underline-offset-8 ml-4'>  ABOUT US</span> 
         
        <div className="sm:min-h-[80px] my-32 mr-32 relative z-10  flex  cursor-pointer items-center overflow-hidden rounded-xl border border-slate-800 p-[1.5px]">
          <div className="animate-rotate absolute inset-0 h-full  rounded-full bg-[conic-gradient(#FBBF24_20deg,transparent_120deg)]"></div>
          <div className="sm:min-h-[50px]   z-20 flex  rounded-[0.60rem] bg-slate-800 p-2 ">

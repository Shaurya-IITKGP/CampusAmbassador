    ...
    <div className='grid grid-flow-row mt-16 justify-center x5:scale-80 x4:scale-90 x4:mt-8 x7:scale-75'>
        ...
        <div className='text-white grid grid-flow-row grid-cols-2 mt-8 justify-center gap-3 x3:grid-cols-1 x3:gap-0 x6:gap-8 x7:gap-9'>
                    ...
                    <div className='grid justify-start grid-flow-col mb-4 x3:scale-80 x2:scale-75 x1:scale-90 xl:scale-100 xm:grid-flow-row'>
                        ...
                        <div className='ml-1 font-mono text-nf grid items-center h-[120px] opacity-85 animate-slide-in-right'>Certificate of Acknowledgment, duly signed by the Chairman of Shaurya IIT Kharagpur and the President of Gymkhana IIT Kharagpur, upon the triumphant completion of the service period.</div>
                    </div>
                    ...
                    <div className='grid justify-start grid-flow-col mb-4 x3:scale-80 x2:scale-75 x1:scale-90 xl:scale-100 xm:grid-flow-row'>
                        ...
                        <div className='ml-1 font-mono text-nf grid items-center h-[120px] opacity-85 animate-slide-in-left'>Privilege to attend all formal events and programs organized by Shaurya IIT Kharagpur.</div>
                    </div>
                    ...
                    <div className='grid justify-start grid-flow-col mb-4 x3:scale-80 x2:scale-75 x1:scale-90 xl:scale-100 xm:grid-flow-row'>
                        ...
                        <div className='ml-1 font-mono text-nf grid items-center h-[120px] opacity-85 animate-slide-in-right'>Premium gift assortments and curated hampers presented upon the fest's conclusion.</div>
                    </div>
                    ...
                    <div className='grid justify-start grid-flow-col mb-4 x3:scale-80 x2:scale-75 x1:scale-90 xl:scale-100 xm:grid-flow-row'>
                        ...
                        <div className='ml-1 font-mono text-nf grid items-center h-[120px] opacity-85 animate-slide-in-left'>Comprehensive networking with IIT Kharagpur students and representatives from a variety of other academic institutions.</div>
                    </div>

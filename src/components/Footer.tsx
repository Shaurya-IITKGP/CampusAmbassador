...
<div className="lg:flex block px-4 lg:px-0 py-8 bg-gradient-to-b from-black via-slate-700 to-orange-900">
        ...
        <div className="lg:w-[45%] w-full flex flex-col items-center  lg:items-center">
          ...
          <p className="text-[15px] mt-4 lg:mt-0 text-white font-bold font-nunito text-center lg:text-left w-[90%]">
            <span className=" text-lightOrange">Shaurya </span>is the annual inter-collegiate sports fest of <span className=' text-lightOrange'>IIT Kharagpur</span>, which is held over a span of three days. It was started in 2008 to promote sports culture and provide a national platform for athletes. <span className=" text-lightOrange">Shaurya </span> witnessed various editions in 2008, 2009, 2010, 2012 amd 2023.
          </p>

...
import firstpic from '../assets/virat-kohli.jpg'
...
const Footer = () => {
  return (
    ...
    <div className=' lg:flex block'>
            ...
            <img className='ml-[15%] w-[50%] h-[300px] '
             ...
             <div className='mt-10 hidden lg:block'>
                ...
                <div className='flex justify-center  gap-7'>
                    <a  href='https://www.facebook.com/share/HFLKcLA25psDVxjR/?mibextid=qi2Omg/' ><img className='w-[30px] h-[30px] cursor-pointer hover:brightness-200 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110' src={facebook_icon.src}   /></a>
                    <a href='https://www.instagram.com/shaurya.iitkgp?igsh=MW1wcGRqNHoyNWgzcA=='><img className='w-[30px] h-[30px] cursor-pointer hover:brightness-200 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110' src={Instagram.src}/></a>
        ...
        <div className='w-[2px] hidden lg:block h-[400px] ml-10 mt-[100px] bg-gradient-to-b from-orange-500 '>
        ...
        <div className='  w-[100%] lg:w-[55%] pt-[80px] pl-4 lg:pl-0'>
            ...
            <div className='min-h-[300px] lg:flex'>
                <div className=' w-[100%] lg:w-[50%] '>
                    <div className=' w-[70%] lg:ml-[20%] mx-auto'>
                        <div className=' mx-auto  w-[154px] h-[204px] bg-gradient-to-r from-amber-500 from-10% via-orange-600 via-30% to-yellow-500 to-90% hover:animate-pulse bg-size-200 rounded-[20px]'>
                            <img className=' w-[150px] h-[200px]  pt-[4px] rounded-[20px] mx-auto mt-[2px]  ' src={firstpic.src}  />
                        </div>
                ...
                <div className='h-[2px] bg-gradient-to-r from-amber-600 to-amber-600 my-7 w-[70%] mx-auto lg:hidden'>
                </div>
